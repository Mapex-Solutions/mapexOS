...
import {
	...
	REDIS_HOST_DEFAULT,
	REDIS_PORT_DEFAULT,
	REDIS_USERNAME_DEFAULT,
	REDIS_PASSWORD_DEFAULT,
	REDIS_DB_DEFAULT,
	REDIS_LOCK_DRIFT_FACTOR_DEFAULT,
	REDIS_LOCK_RETRY_COUNT_DEFAULT,
	REDIS_LOCK_RETRY_DELAY_DEFAULT,
	REDIS_LOCK_RETRY_JITTER_DEFAULT,
	NATS_URL_DEFAULT,
	...
	MINIO_ASSETS_BUCKET_DEFAULT,
	MINIO_TEMPLATES_BUCKET_DEFAULT,
	MINIO_BYTECODE_BUCKET_DEFAULT,
	...
	CONCURRENCY_CHUNK_SIZE_DEFAULT,
	EVENTS_PER_WORKER_DEFAULT,
} from './constants';
...
export const defaultConfiguration: ConfigDefinition[] = [
	...
	/* Redis Configuration */
	{ key: 'redis_host', env: 'REDIS_HOST', type: 'string', default: REDIS_HOST_DEFAULT },
	{ key: 'redis_port', env: 'REDIS_PORT', type: 'int', default: REDIS_PORT_DEFAULT },
	{ key: 'redis_username', env: 'REDIS_USERNAME', type: 'string', default: REDIS_USERNAME_DEFAULT },
	{ key: 'redis_password', env: 'REDIS_PASSWORD', type: 'string', default: REDIS_PASSWORD_DEFAULT },
	{ key: 'redis_db', env: 'REDIS_DB', type: 'int', default: REDIS_DB_DEFAULT },

	/* Redis Lock Configuration */
	{ key: 'redis_lock_drift_factor', env: 'REDIS_LOCK_DRIFT_FACTOR', type: 'int', default: REDIS_LOCK_DRIFT_FACTOR_DEFAULT },
	{ key: 'redis_lock_retry_count', env: 'REDIS_LOCK_RETRY_COUNT', type: 'int', default: REDIS_LOCK_RETRY_COUNT_DEFAULT },
	{ key: 'redis_lock_retry_delay', env: 'REDIS_LOCK_RETRY_DELAY', type: 'int', default: REDIS_LOCK_RETRY_DELAY_DEFAULT },
	{ key: 'redis_lock_retry_jitter', env: 'REDIS_LOCK_RETRY_JITTER', type: 'int', default: REDIS_LOCK_RETRY_JITTER_DEFAULT },
	...
	{ key: 'auth_roles_source', env: 'AUTH_ROLES_SOURCE', type: 'string', default: AUTH_ROLES_SOURCE_DEFAULT }, // token | db | api
	...
	{ key: 'assets_service_url', env: 'ASSETS_SERVICE_URL', type: 'string', default: ASSETS_SERVICE_URL_DEFAULT },
	...
	{ key: 'minio_assets_bucket', env: 'MINIO_ASSETS_BUCKET', type: 'string', default: MINIO_ASSETS_BUCKET_DEFAULT },
	{ key: 'minio_templates_bucket', env: 'MINIO_TEMPLATES_BUCKET', type: 'string', default: MINIO_TEMPLATES_BUCKET_DEFAULT },
	{ key: 'minio_bytecode_bucket', env: 'MINIO_BYTECODE_BUCKET', type: 'string', default: MINIO_BYTECODE_BUCKET_DEFAULT },
	...
	{ key: 'nats_consumer_batch_size', env: 'NATS_CONSUMER_BATCH_SIZE', type: 'int', default: NATS_CONSUMER_BATCH_SIZE_DEFAULT },          // 0 = auto (CPU_LIMIT × 500)
	...
	{ key: 'nats_consumer_max_ack_pending', env: 'NATS_CONSUMER_MAX_ACK_PENDING', type: 'int', default: NATS_CONSUMER_MAX_ACK_PENDING_DEFAULT }, // 0 = auto (batchSize × 2)

	/** Concurrency chunk size (0 = auto from PISCINA_WORKERS × 8) */
	{ key: 'concurrency_chunk_size', env: 'CONCURRENCY_CHUNK_SIZE', type: 'int', default: CONCURRENCY_CHUNK_SIZE_DEFAULT },

	/** Events per piscina.run() call for batch workers (0 = auto: 500) */
	{ key: 'events_per_worker', env: 'EVENTS_PER_WORKER', type: 'int', default: EVENTS_PER_WORKER_DEFAULT },
];
