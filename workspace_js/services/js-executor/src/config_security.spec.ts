...
/**
 * Curated list of every configuration key that MUST carry `sensitive: true`
 * in this service's defaultConfiguration. Adding a new credential without
 * updating this list fails the regression test below.
 */
...
describe('js-executor config security', () => {
