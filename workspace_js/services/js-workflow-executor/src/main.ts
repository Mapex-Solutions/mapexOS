...
import { initConfig, initMetrics, initNATS, initCache, initExpress, initHealth, initShutdown } from './bootstrap';
import { initModule } from '@modules/app/module';

// Main function to start the JS Workflow Executor service
