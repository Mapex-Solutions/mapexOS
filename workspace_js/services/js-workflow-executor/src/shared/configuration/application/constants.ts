...
export const HTTP_PORT_DEFAULT = 8001;
export const HTTP_ADDRESS_DEFAULT = '0.0.0.0';
export const SERVICE_NAME_DEFAULT = 'js-workflow-executor';
...
export const NATS_CLIENT_NAME_DEFAULT = 'js-workflow-executor-service';
...
export const AUTH_ROLES_SOURCE_DEFAULT = 'token';
...
// Workflow service — fallback HTTP base URL to fetch script source on L2 miss.
export const WORKFLOW_SERVICE_URL_DEFAULT = 'http://localhost:5010';
...
// Object store (MinIO/S3) — endpoint, scoped credentials (sensitive), bucket.
export const OBJECT_STORE_ENDPOINT_DEFAULT = 'localhost:9000';
export const OBJECT_STORE_ACCESS_KEY_DEFAULT = 'svc-jsworkflow';
export const OBJECT_STORE_SECRET_KEY_DEFAULT = 'svc-jsworkflow-secret-change-me';
...
export const MINIO_WORKFLOWS_BUCKET_DEFAULT = 'mapex-workflows';
...
export const NATS_CONSUMER_BATCH_SIZE_DEFAULT = 0;
export const NATS_CONSUMER_FETCH_TIMEOUT_DEFAULT = 1000; // 1000ms = 1s fetch timeout
export const NATS_CONSUMER_MAX_ACK_PENDING_DEFAULT = 0;
