...
/**
 * Creates Plugin module API with user endpoints.
 *
 ...
 */
export function createPluginApi(http: AxiosInstance, getToken: GetToken | undefined) {
	return {
		...userApi(http, getToken),
	};
}

export type PluginApiMethods = ReturnType<typeof createPluginApi>;
