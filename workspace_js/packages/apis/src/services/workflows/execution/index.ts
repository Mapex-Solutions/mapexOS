...
/**
 * Creates Execution module API with user endpoints.
 *
 ...
 */
export function createExecutionApi(http: AxiosInstance, getToken: GetToken | undefined) {
	return {
		...userApi(http, getToken),
	};
}

export type ExecutionApiMethods = ReturnType<typeof createExecutionApi>;
