...
export function useCreateEditWorkflowTranslations() {
  ...
  return {
    ...
    pluginsTab: {
      ...
      marketplaceLoadError: computed(() => tsTitle(`${basePath}.pluginsTab.marketplaceLoadError`)),
      marketplaceLoadErrorDesc: computed(() => ts(`${basePath}.pluginsTab.marketplaceLoadErrorDesc`)),
      retry: computed(() => tsTitle(`${basePath}.pluginsTab.retry`)),
