...
export function useMainLayoutTranslations() {
  ...
  return {
    ...
    menu: {
      ...
      assetsMarketplace: computed(() => ts('layout.mainLayout.menu.assetsMarketplace')),
      templateMigrations: computed(() => ts('layout.mainLayout.menu.templateMigrations')),
      otaPlans: computed(() => ts('layout.mainLayout.menu.otaPlans')),
