/** TYPE IMPORTS */
import type { FieldSourceValue } from './fieldSource.interface';
import type { ComparisonOperator } from '@src/components/workflow/nodes/conditionNode/constants/conditionNode.constant';
