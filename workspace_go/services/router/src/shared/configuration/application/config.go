...
// DefaultConfiguration defines all configuration keys for the Router service.
//
...
var DefaultConfiguration = []config.ConfigDefinition{
	...
	{Key: "http_port", Env: "HTTP_PORT", Type: "int", Default: 5003},
	...
	{Key: "mongo_database", Env: "MONGO_DATABASE", Type: "string", Default: "router"},
	...
	{Key: "nats_client_name", Env: "NATS_CLIENT_NAME", Type: "string", Default: "router-service"},

	/** NATS Consumer Configuration */
	{Key: "nats_batch_size", Env: "NATS_BATCH_SIZE", Type: "int", Default: 8000},
	...
	* This api Is used for internal communication between services
	...
	{Key: "cache_fallback_timeout", Env: "CACHE_FALLBACK_TIMEOUT", Type: "int", Default: 5}, // seconds
