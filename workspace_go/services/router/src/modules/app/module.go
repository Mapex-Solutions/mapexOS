...
import (
	...
	configMod "router/src/shared/configuration/modules"
)
...
func InitModule(c *fiber.App) {
	...
	logger.Info("[MODULE:App] Phase 1 - Initializing Repositories")
	...
	logger.Info("[MODULE:App] Phase 2 - Initializing Services")
	...
	logger.Info("[MODULE:App] Phase 3 - Initializing Interfaces (HTTP Routes & Consumers)")
