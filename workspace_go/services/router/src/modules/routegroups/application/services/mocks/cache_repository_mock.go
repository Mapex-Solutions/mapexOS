...
// Compile-time check to ensure MockCacheRepository implements CacheRepository.
var _ repositories.CacheRepository = (*MockCacheRepository)(nil)
...
// MockCacheRepository is a mock implementation of CacheRepository (Cache + CacheGetOrSetEx).
...
func (m *MockCacheRepository) Set(_ context.Context, key string, value interface{}) error {
...
func (m *MockCacheRepository) SetEx(_ context.Context, key string, value interface{}, ttl time.Duration) error {
...
func (m *MockCacheRepository) Get(_ context.Context, key string, dest interface{}) error {
...
func (m *MockCacheRepository) Del(_ context.Context, key string) error {
...
func (m *MockCacheRepository) GetOrSetEx(params common.GetOrSetParams) (any, error) {
