...
var DefaultConfiguration = []config.ConfigDefinition{
	...
	{Key: "service_name", Env: "SERVICE_NAME", Type: "string", Default: "mapexIam"},
	...
	{Key: "mongo_database", Env: "MONGO_DATABASE", Type: "string", Default: "mapex_iam"},
	...
	{Key: "nats_client_name", Env: "NATS_CLIENT_NAME", Type: "string", Default: "mapexIam-service"},
