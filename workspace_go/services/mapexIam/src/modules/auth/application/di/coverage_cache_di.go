...
// CoverageCacheRepositoryDI defines the dependency injection container for CoverageCacheRepository.
// This struct aggregates all dependencies required by CoverageCacheRepository using dig.In.
//
...
//
// Used by:
//   - CoverageCacheRepository (as single dependency container)
type CoverageCacheRepositoryDI struct {
	dig.In
