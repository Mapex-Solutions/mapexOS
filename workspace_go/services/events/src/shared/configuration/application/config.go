...
var DefaultConfiguration = []config.ConfigDefinition{
	...
	* This api Is used for internal communication between services
	...
	{Key: "object_store_access_key", Env: "OBJECT_STORE_ACCESS_KEY", Type: "string", Default: "svc-events", Sensitive: true},
	{Key: "object_store_secret_key", Env: "OBJECT_STORE_SECRET_KEY", Type: "string", Default: "svc-events-secret-change-me", Sensitive: true},
