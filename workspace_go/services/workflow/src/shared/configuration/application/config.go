...
var DefaultConfiguration = []config.ConfigDefinition{
	...
	*	Internal API key for service-to-service communication
	...
	{Key: "object_store_access_key", Env: "OBJECT_STORE_ACCESS_KEY", Type: "string", Default: "svc-workflow", Sensitive: true},
	{Key: "object_store_secret_key", Env: "OBJECT_STORE_SECRET_KEY", Type: "string", Default: "svc-workflow-secret-change-me", Sensitive: true},
