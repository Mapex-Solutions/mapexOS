...
// DefaultConfiguration defines all configuration keys for the HTTP Gateway service.
//
...
var DefaultConfiguration = []config.ConfigDefinition{
	...
	{Key: "http_port", Env: "HTTP_PORT", Type: "int", Default: 5001},
	{Key: "http_address", Env: "HTTP_ADDRESS", Type: "string", Default: "0.0.0.0"},

	{Key: "service_name", Env: "SERVICE_NAME", Type: "string", Default: "http_gateway"},
	...
	{Key: "mongo_database", Env: "MONGO_DATABASE", Type: "string", Default: "http_gateway"},
	...
	{Key: "nats_client_name", Env: "NATS_CLIENT_NAME", Type: "string", Default: "http-gateway-service"},
