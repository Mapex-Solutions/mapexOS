...
const (
	...
	// BagKeyTelemetrySentAt is the UTC timestamp captured by
	// PostRawEvent before the gateway returns. Asserts that scope
	// event_trigger queries by time read it.
	BagKeyTelemetrySentAt = "httpGateway.telemetrySentAt"
)
