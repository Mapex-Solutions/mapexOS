module github.com/Mapex-Solutions/MapexOS/e2eTests
...
// Local module resolution — these modules are not published; replace
// to the sibling repos. Layout is documented in go.work.
replace (
	github.com/Mapex-Solutions/MapexOS/contracts => ../workspace_go/packages/contracts
	github.com/Mapex-Solutions/MapexOS/permissions => ../workspace_go/packages/permissions
	github.com/Mapex-Solutions/mapexGoKit/infrastructure => ../../mapexGoKit/infrastructure
	github.com/Mapex-Solutions/mapexGoKit/microservices => ../../mapexGoKit/microservices
	github.com/Mapex-Solutions/mapexGoKit/utils => ../../mapexGoKit/utils
)
