...
- events     reachable at `EVENTS_URL`  (default `http://localhost:5004`) — the lorawan journeys assert ingestion via `/api/v1/events/raw`
- mapexLNS   (LoRaWAN journeys only) at the UDP + Basics Station ingresses:
