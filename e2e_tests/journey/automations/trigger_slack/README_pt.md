# Journey: Trigger Slack

## O que esta journey prova

O trigger Slack do serviço triggers dispara pelo pipeline ao vivo e
faz POST do payload do webhook para um listener HTTP real (mesmo
formato que um webhook do Slack receberia).
